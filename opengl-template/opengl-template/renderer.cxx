...
void Renderer::Draw(const VertexArray& vao, const IndexBuffer& ibo,
  ...
  // If we don't have an ibo we can call: (in this case we should have all of
  // the vertices repeated). glDrawArrays(GL_TRIANGLES, /* index of the first
  // component */ 0, number_of_vertices);
